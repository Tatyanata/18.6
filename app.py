...
def start(message: telebot.types.Message):
    text = 'Привет! Я Бот-конвертер. Я могу: \n- Произвести конвертацию через запрос формат: <имя валюты> \
<в какую валюту перевести> \
<количество перводимой валюты>\n- Показать список доступных валют введите: /values \
...
def get_price(message: telebot.types.Message):
    try:
        ...
        if len(values) != 3:
            raise APIException('Число параметров не соответствует формату.\n Введите команду или 3 параметра')
